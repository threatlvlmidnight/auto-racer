...
expose eligibility, resource, and risk before commitment.
...
and bounded animation only; new `1x` ≈ legacy 20 seconds and new `2x` ≈ 10 seconds

**Scale/Scope**: Four player identities, generated rival identities, 8-car fields,
8/10/12/14/16 laps, three phases, five consequential event families, scored and
Test Day presentation
...
7. Tune with centralized configuration and corpus gates, then verify incidents
