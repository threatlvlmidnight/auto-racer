...
export const VOSS_ITEMS: readonly ItemDefinition[] = [
  ...
  item({ id: "voss-adjustable-bodywork-stay", name: "Adjustable Bodywork Stay", price: 4, installationCategory: "chassis", synergyTags: ["loophole", "control"], conditionalPhysics: [{ condition: { kind: "corner-tightness", direction: "at-most", turnDegrees: 40 }, delta: { topSpeedDelta: 2 } }], configurableSetup: { family: "bodywork-trim", magnitude: 1 } }),
  item({ id: "voss-split-circuit-brake-valve", name: "Split-Circuit Brake Valve", price: 4, installationCategory: "chassis", synergyTags: ["control", "pressure"], physics: { brakingPowerDelta: 26 }, configurableSetup: { family: "brake-balance", magnitude: 1 } }),
