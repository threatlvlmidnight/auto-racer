...
export const ROOK_ITEMS: readonly ItemDefinition[] = [
  ...
  item({ id: "rook-differential-braking-valve", name: "Differential Braking Valve", price: 4, installationCategory: "chassis", synergyTags: ["pressure", "control"], physics: { brakingPowerDelta: 26 } }),
  item({ id: "rook-gyroscopic-stabilizer", name: "Gyroscopic Stabilizer", price: 4, installationCategory: "chassis", synergyTags: ["control", "experimental"], conditionalPhysics: [{ condition: { kind: "corner-tightness", direction: "at-least", turnDegrees: TIGHT }, delta: { corneringSpeedDelta: 6 } }] }),
